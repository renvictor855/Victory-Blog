...
<div class="goods-grid">
    <div class="good-card">
        ...
        <div class="good-info">
            ...
            <div class="good-desc">主力电脑，主要用于生产力工作（2022.06）</div>
        </div>
    </div>
    <div class="good-card">
        ...
        <div class="good-info">
            ...
            <div class="good-desc">备用电脑，MacOS平台当年的尝鲜（2021.12）</div>
        </div>
    </div>
    <div class="good-card">
        ...
        <div class="good-info">
            ...
            <div class="good-desc">主力手机，1TB超大存储（2025.07购入）</div>
        </div>
    </div>
    <div class="good-card">
        ...
        <div class="good-info">
            ...
            <div class="good-desc">摄像手机，小屏超棒，Leica加持（2024.05）</div>
        </div>
    </div>
    <div class="good-card">
        ...
        <div class="good-info">
            ...
            <div class="good-desc">目前当作电脑副屏使用，性能出色（2022.07）</div>
        </div>
    </div>
    <div class="good-card">
        ...
        <div class="good-info">
            ...
            <div class="good-desc">监测健康和锻炼使用，颜值极高（2024.01）</div>
        </div>
    </div>
    <div class="good-card">
    ...
    <div class="good-card">
        ...
        <div class="good-info">
            ...
            <div class="good-desc">做了 Win To Go，存储重要文件（2021.06）</div>
        </div>
    </div>
</div>